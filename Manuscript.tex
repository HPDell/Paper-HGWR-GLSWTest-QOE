...
The effect-wise bootstrap uses $B=199$ resamples for 250 data sets under each global-null scenario and for 100 data sets at $a=0.5$ and $a=1$ with \gls{icc} 0.4.
The smaller bootstrap allocation reflects its substantially greater computational cost.
The full-model bootstrap is evaluated at the two \gls{icc} 0.4 endpoints using 50 data sets, and independent $B=999$ confirmation experiments use 20 data sets at each endpoint.
